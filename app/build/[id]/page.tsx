...
import { mockBuilds, mockStores } from "@/lib/mock-data"
...
export default function BuildViewPage({ params }: { params: Promise<{ id: string }> }) {
  const resolvedParams = use(params)
  const { toast } = useToast()
  const build = mockBuilds.find((b) => b.id === resolvedParams.id)
  ...
  const handleShare = () => {
    toast({
      ...
      description: "El enlace del build se copió al portapapeles",
    })
  }
